...
export function PlatformFuture() {
  ...
  return (
    <section id="platform" className={styles.section} aria-labelledby="platform-title">
      <div className={styles.inner}>
        <h2 id="platform-title" className={styles.heading}>
          Платформа будущего
        </h2>

        <div className={styles.tabBar} role="tablist" aria-label="Разделы платформы">
          {tabs.map((t) => (
            <button
              key={t.id}
              type="button"
        ...
        <div className={styles.grid}>
          <article className={styles.heroCard}>
            ...
            <Shield className={styles.shield} size={120} strokeWidth={1} aria-hidden />
